...
<html xmlns="http://www.w3.org/1999/xhtml" <?php do_action( 'admin_xml_ns' ); ?> <?php language_attributes(); ?>>
	<head>
		...
		<script src="<?php echo plugins_url( 'pub/js/metadata.js?ver=' . W3TC_VERSION, W3TC_FILE ); ?>"></script>
		<script src="<?php echo plugins_url( 'pub/js/popup.js?ver=' . W3TC_VERSION, W3TC_FILE ); ?>"></script>
